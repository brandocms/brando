...
test('rich-text link picker applies, cancels and removes links', async ({ page }, testInfo) => {
  ...
  await modal.getByRole('textbox', { name: 'URL', exact: true }).fill('https://example.com/project')
  ...
  await expect(editor.locator('a')).toHaveAttribute('href', 'https://example.com/project')
  await page.getByRole('button', { name: 'Link', exact: true }).click()
  await expect(modal.getByRole('textbox', { name: 'URL', exact: true })).toHaveValue('https://example.com/project')
