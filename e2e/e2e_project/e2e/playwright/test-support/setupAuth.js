...
export const test = baseTest.extend({
  ...
  page: async ({ browser, scenario }, use) => {
    const authResponse = await fetch('http://localhost:4444/e2e/login/admin@brandocms.com', {
      method: 'POST'
    })
    ...
    console.log(`
      ...
      userAgentString: ${userAgentString} —— checking in.
    ...
    console.log('==> after SANDBOX delete.')
  }
})
