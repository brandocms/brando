defmodule BrandoAdmin.Components.Form.Input.Select do
  ...
  defp extract_label(%Brando.Content.OldVar.Select.Option{label: label}), do: label
  ...
  defp extract_value(%Brando.Content.OldVar.Select.Option{value: value}), do: value
