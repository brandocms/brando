defmodule Brando.Routes.Admin.Images do
  ...
  defp add_resources(path, opts) do
    ...
    quote do
      ...
      get "#{path}/serier/ny/:id", series_ctrl, :new, Keyword.put(opts, :as, "image_series")
      ...
      get "#{path}/serier/:filter/sorter", series_ctrl, :sequence, Keyword.put(opts, :as, "image_series")
      post "#{path}/serier/:filter/sorter", series_ctrl, :sequence_post, Keyword.put(opts, :as, "image_series")
