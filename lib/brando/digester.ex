defmodule Brando.Digester do
  ...
  @comment "This file was auto-generated by `mix brando.digest`. Remove it and all generated artefacts with `mix brando.digest.clean --all`"
  ...
  defp map_file(file_path, input_path) do
    ...
    # leave vite assets alone
    digested_filename =
      case extension do
        ".css" -> "#{rootname}.css"
        ".js" -> "#{rootname}.js"
        ".map" -> "#{rootname}.map"
        _ -> "#{rootname}-#{digest}#{extension}"
      end
  ...
  defp write_to_disk(file, output_path) do
    ...
    # uncompressed files, only write non-digested if necessary
    if file.filename != file.digested_filename do
