defmodule Mix.Tasks.Brando.Install do
  ...
  @new [
    ...
    {:eex, "templates/brando.install/lib/application_name/release_tasks.ex", "lib/application_name/release_tasks.ex"},
    ...
    {:text, "templates/brando.install/lib/application_name_web/templates/page/_footer.html.eex", "lib/application_name_web/templates/page/_footer.html.eex"},
    {:text, "templates/brando.install/lib/application_name_web/templates/page/__logo.html.eex", "lib/application_name_web/templates/page/__logo.html.eex"},
  ...
  @static [
    ...
    # Backend assets
    {:copy, "templates/brando.install/assets/backend/babel.config.js", "assets/backend/babel.config.js"},
    {:copy, "templates/brando.install/assets/backend/browserslistrc", "assets/backend/.browserslistrc"},
    ...
    {:copy, "templates/brando.install/assets/backend/postcssrc.js", "assets/backend/.postcssrc.js"},
    {:copy, "templates/brando.install/assets/backend/vue.config.js", "assets/backend/vue.config.js"},
    ...
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-light-300.eot", "assets/backend/public/fonts/fa-light-300.eot"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-light-300.otf", "assets/backend/public/fonts/fa-light-300.otf"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-light-300.svg", "assets/backend/public/fonts/fa-light-300.svg"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-light-300.ttf", "assets/backend/public/fonts/fa-light-300.ttf"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-light-300.woff", "assets/backend/public/fonts/fa-light-300.woff"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-light-300.woff2", "assets/backend/public/fonts/fa-light-300.woff2"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-solid-900.eot", "assets/backend/public/fonts/fa-solid-900.eot"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-solid-900.otf", "assets/backend/public/fonts/fa-solid-900.otf"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-solid-900.svg", "assets/backend/public/fonts/fa-solid-900.svg"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-solid-900.ttf", "assets/backend/public/fonts/fa-solid-900.ttf"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-solid-900.woff", "assets/backend/public/fonts/fa-solid-900.woff"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/fa-solid-900.woff2", "assets/backend/public/fonts/fa-solid-900.woff2"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/osb.woff", "assets/backend/public/fonts/osb.woff"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/osr.woff", "assets/backend/public/fonts/osr.woff"},
    {:copy, "templates/brando.install/assets/backend/public/fonts/osr.woff2", "assets/backend/public/fonts/osr.woff2"},
    {:copy, "templates/brando.install/assets/backend/public/images/admin/avatar.png", "assets/backend/public/images/admin/avatar.png"},
    {:copy, "templates/brando.install/assets/backend/src/styles/app.scss", "assets/backend/src/styles/app.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_animated.scss", "assets/backend/src/styles/fontawesome/_animated.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_bordered-pulled.scss", "assets/backend/src/styles/fontawesome/_bordered-pulled.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_core.scss", "assets/backend/src/styles/fontawesome/_core.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_fixed-width.scss", "assets/backend/src/styles/fontawesome/_fixed-width.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_icons.scss", "assets/backend/src/styles/fontawesome/_icons.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_larger.scss", "assets/backend/src/styles/fontawesome/_larger.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_list.scss", "assets/backend/src/styles/fontawesome/_list.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_mixins.scss", "assets/backend/src/styles/fontawesome/_mixins.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_rotated-flipped.scss", "assets/backend/src/styles/fontawesome/_rotated-flipped.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_screen-reader.scss", "assets/backend/src/styles/fontawesome/_screen-reader.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_stacked.scss", "assets/backend/src/styles/fontawesome/_stacked.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/_variables.scss", "assets/backend/src/styles/fontawesome/_variables.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/fontawesome-pro-core.scss", "assets/backend/src/styles/fontawesome/fontawesome-pro-core.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/fontawesome-pro-light.scss", "assets/backend/src/styles/fontawesome/fontawesome-pro-light.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/fontawesome-pro-regular.scss", "assets/backend/src/styles/fontawesome/fontawesome-pro-regular.scss"},
    {:copy, "templates/brando.install/assets/backend/src/styles/fontawesome/fontawesome-pro-solid.scss", "assets/backend/src/styles/fontawesome/fontawesome-pro-solid.scss"},
    ...
    # Frontend assets
    {:copy, "templates/brando.install/assets/frontend/babel.config.js", "assets/frontend/babel.config.js"},
    ...
    {:copy, "templates/brando.install/assets/frontend/css/includes/_content.scss", "assets/frontend/css/includes/_content.scss"},
    {:copy, "templates/brando.install/assets/frontend/css/includes/_cookies.scss", "assets/frontend/css/includes/_cookies.scss"},
    ...
    {:copy, "templates/brando.install/assets/frontend/css/includes/_footer.scss", "assets/frontend/css/includes/_footer.scss"},
    {:copy, "templates/brando.install/assets/frontend/css/includes/_hamburgers.scss", "assets/frontend/css/includes/_hamburgers.scss"},
    {:copy, "templates/brando.install/assets/frontend/css/includes/_header.scss", "assets/frontend/css/includes/_header.scss"},
    ...
    {:copy, "templates/brando.install/assets/frontend/css/includes/_templates.scss", "assets/frontend/css/includes/_templates.scss"},
    ...
    {:copy, "templates/brando.install/assets/frontend/js/slider/index.js", "assets/frontend/js/slider/index.js"},
