defmodule Mix.Tasks.Brando.Gen.Backend do
  ...
  def run(_) do
    ...
    files = [
      ...
      {:copy, "assets/backend/public/fonts/Main-Bold.woff",
       "assets/backend/public/fonts/Main-Bold.woff"},
      {:copy, "assets/backend/public/fonts/Main-Light.woff",
       "assets/backend/public/fonts/Main-Light.woff"},
      {:copy, "assets/backend/public/fonts/Main-Medium.woff",
       "assets/backend/public/fonts/Main-Medium.woff"},
      {:copy, "assets/backend/public/fonts/Main-Regular.woff",
       "assets/backend/public/fonts/Main-Regular.woff"},
