...
Existing coverage to preserve includes [image library browsing](../../../e2e/playwright/tests/assets/images.spec.js), [file resource replacement](../../../e2e/playwright/tests/assets/files.spec.js), [video folder metadata](../../../e2e/playwright/tests/assets/videos.spec.js), [block variable uploads](../../../e2e/playwright/tests/blocks/block-var-uploads.spec.js), [entry variable persistence](../../../e2e/playwright/tests/pages/page-vars-upload.spec.js), [gallery remove/add persistence](../../../e2e/playwright/tests/blocks/block-gallery-image-replace.spec.js), [file synchronization between editors](../../../e2e/playwright/tests/projects/file-field-sync.spec.js) and [modal behavior](../../../e2e/playwright/tests/modal-design.spec.js). Extend the relevant tests for new drop/replacement states. These tests were identified for implementation validation; this document review did not run them.
