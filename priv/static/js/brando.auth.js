...
require.register('textfit', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'textfit//')); }), {});
    (function(exports,require,module) {
      /**
 * textFit v2.1.1
...
})();window.$ = require('jquery');window.jQuery = require('jquery');require.register("brando_auth", function(exports, require, module) {
"use strict";
