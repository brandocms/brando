...
require.register("textfit/textFit.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "textfit");
  (function() {
    /**
 * textFit v2.1.1
...
require.alias("vex-js/js/vex.js", "vex-js");
require.alias("moment/moment.js", "moment");
require.alias("chartjs-color/src/color.js", "chartjs-color");
require.alias("color-string/color-string.js", "color-string");require.register("___globals___", function(exports, require, module) {
