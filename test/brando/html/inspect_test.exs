defmodule Brando.HTML.InspectTest do
  ...
  @association_has %Ecto.Association.Has{assoc: Brando.Image, assoc_key: :image_series_id, cardinality: :many, field: :images, owner: Brando.ImageSeries, owner_key: :id, queryable: Brando.Image}
