...
defmodule Brando.Instagram.ControllerTest do
  ...
  test "index" do
    ...
    assert html_response(conn, 200) =~ "data-status=\"approved\" src=\"/media/images/instagram/thumb/dummy_1.jpg\""
    assert html_response(conn, 200) =~ "data-status=\"approved\" src=\"/media/images/instagram/thumb/dummy_2.jpg\""
    assert html_response(conn, 200) =~ "data-status=\"approved\" src=\"/media/images/instagram/thumb/dummy_3.jpg\""
    ...
    assert html_response(conn, 200) =~ "data-status=\"deleted\" src=\"/media/images/instagram/thumb/dummy_1.jpg\""
    ...
    assert html_response(conn, 200) =~ "data-status=\"rejected\" src=\"/media/images/instagram/thumb/dummy_1.jpg\""
