defmodule Brando.Instagram.ControllerTest do
  ...
  @img1 %{
    "caption" => "Caption1",
    "created_time" => "1432154962",
    "image" => %Brando.Type.Image{
      credits: nil,
      optimized: false,
      path: "images/instagram/dummy_1.jpg",
      sizes: %{
        large: "images/instagram/large/dummy_1.jpg",
        thumb: "images/instagram/thumb/dummy_1.jpg"
      },
      title: nil
    },
  ...
  @img2 %{
    "caption" => "Caption2",
    "created_time" => "1432154963",
    "image" => %Brando.Type.Image{
      credits: nil,
      optimized: false,
      path: "images/instagram/dummy_2.jpg",
      sizes: %{
        large: "images/instagram/large/dummy_2.jpg",
        thumb: "images/instagram/thumb/dummy_2.jpg"
      },
      title: nil
    },
  ...
  @img3 %{
    "caption" => "Caption3",
    "created_time" => "1432154964",
    "image" => %Brando.Type.Image{
      credits: nil,
      optimized: false,
      path: "images/instagram/dummy_3.jpg",
      sizes: %{
        large: "images/instagram/large/dummy_3.jpg",
        thumb: "images/instagram/thumb/dummy_3.jpg"
      },
      title: nil
    },
