defmodule Brando.Field.Image.SchemaTest do
  ...
  test "list_image_fields" do
    assert Brando.Field.Image.Schema.list_image_fields() == [
             ...
             %{fields: [:logo], source: "sites_identity"},
             %{fields: [:fallback_meta_image], source: "sites_seo"},
